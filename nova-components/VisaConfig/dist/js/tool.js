...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    generateCredentials: function generateCredentials() {
      ...
      this.isLoading = true;
      if (this.email == "" || this.serial == "" || this.affiliation == "" || this.user == "" || this.password == "") {
        this.$toasted.show("Debe completar todos los campos.", {
          type: "error"
        });
        return;
      }
      axios.post("/zuma/visa-config/generate-credentials", {
        email: this.email,
        serial: this.serial,
        ...
        switch (data.message) {
          case "email_not_found":
            _this.$toasted.show("El usuario indicado no existe.", {
              type: "error"
            });
            break;
          case "already_registered":
            _this.$toasted.show("El usuario ingresado ya tiene credenciales.", {
              type: "error"
            });
            break;
          case "invalid_credentials":
            _this.$toasted.show("Las credenciales son inválidas.", {
              type: "error"
            });
            break;
          case "registered_successfully":
            _this.$toasted.show("Las credenciales se generaron exitosamente.", {
              type: "success"
            });
            break;
          default:
            _this.$toasted.show("Ocurrió un error inesperado, intenta más tarde.", {
              type: "error"
            });
            break;
        }
        ...
        _this.$toasted.show("Ocurrió un error con su conexión, intenta más tarde.", {
          type: "error"
        });
        _this.isLoading = false;
      });
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Configuración VISA")]),
      _vm._v(" "),
          ...
          [
            ...
            _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
              ...
              _c("div", { staticClass: "help-text help-text mt-2" }, [
                _vm._v(
                  "Correo electrónico de la persona asociada a ZUMA que cuenta con un número de afiliación a VISA."
                )
              ])
            ])
          ]
          ...
          [
            ...
            _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
              _c("input", {
                ...
                staticClass:
                  "w-full form-control form-input form-input-bordered",
                attrs: { type: "text", placeholder: "Número de afiliación" },
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.affiliation = $event.target.value
                  }
                }
              }),
              _vm._v(" "),
              _c("div", { staticClass: "help-text help-text mt-2" }, [
                _vm._v(
                  "Número de afiliación de VISA del usuario que solicita POS."
                )
              ])
            ])
          ]
          ...
          [
            ...
            _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
              _c("input", {
                ...
                staticClass:
                  "w-full form-control form-input form-input-bordered",
                attrs: { placeholder: "Número de serie" },
              ...
              _vm._v(" "),
              _c("div", { staticClass: "help-text help-text mt-2" }, [
                _vm._v("Número de serie del POS a enviarle al usuario.")
              ])
            ])
          ]
        ),
          ...
          [
            ...
            _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
              _c("input", {
                ...
                staticClass:
                  "w-full form-control form-input form-input-bordered",
                attrs: { placeholder: "Usuario de afiliación" },
              ...
              _vm._v(" "),
              _c("div", { staticClass: "help-text help-text mt-2" }, [
                _vm._v("Usuario de la afiliación de VISA.")
              ])
            ])
          ]
        ),
          ...
          [
            ...
            _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
              _c("input", {
                ...
                staticClass:
                  "w-full form-control form-input form-input-bordered",
                attrs: { placeholder: "Contraseña de afiliación" },
              ...
              _vm._v(" "),
              _c("div", { staticClass: "help-text help-text mt-2" }, [
                _vm._v("Contraseña de la afiliación de VISA.")
              ])
            ])
          ]
        )
      ...
      _c("div", { staticClass: "flex items-center mt-2" }, [
        _c(
          "button",
          {
            ...
            on: { click: _vm.generateCredentials }
          },
          [_c("span", {}, [_vm._v("Generar credenciales")])]
        )
      ])
    ],
    1
